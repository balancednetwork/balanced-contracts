...
def test_originatecase2():
    ...
    for case in test_cases['stories']:
        ...
        print('.....Test Successfull...')
        res = call_tx('loans', _acc_method, _acc_params)
        assert res['standing'] == case['actions']['expected_result'], 'Test case failed'
        print('.....Test Successfull...')



def test_originatecase3():
