...
contracts = {'loans': {'zip': 'core_contracts/loans.zip', 'SCORE': 'cx936c3891a9fb3994017a5aec4bc177c3785f7cd1'},
             'staking': {'zip': 'core_contracts/staking.zip', 'SCORE': 'cxc586330cf2842983288789d4ee0907a1e211b1ab'},
             'dividends': {'zip': 'core_contracts/dividends.zip',
                           'SCORE': 'cx47200a38c304b595af42a16da1072a9c147e2584'},
             ...
             'rewards': {'zip': 'core_contracts/rewards.zip', 'SCORE': 'cx4a29d6d15acb6e4a1c6ad38c0742dd8fc9cc7286'},
             'dex': {'zip': 'core_contracts/dex.zip', 'SCORE': 'cx8b27346ec42e4f49ef18731d7f0d393876b0ceb7'},
             'governance': {'zip': 'core_contracts/governance.zip',
                            'SCORE': 'cx7f1d0edd9382fe80ddde3a80d6bc98808e0ae366'},
             'oracle': {'zip': 'core_contracts/oracle.zip', 'SCORE': 'cx61a36e5d10412e03c907a507d1e8c6c3856d9964'},
             'sicx': {'zip': 'token_contracts/sicx.zip', 'SCORE': 'cx2a64879449803a6a0c83828cbb8a45ee1674fa82'},
             'bnUSD': {'zip': 'token_contracts/bnUSD.zip', 'SCORE': 'cx384e06e3fe37ad7933d8bad35fd8835c643c17fd'},
             'bnXLM': {'zip': 'token_contracts/bnXLM.zip', 'SCORE': 'cxc9db156d46cb778692064752511a6a3b1c467557'},
             'bnDOGE': {'zip': 'token_contracts/bnDOGE.zip', 'SCORE': 'cx6a140794f90a3e02fa8bf6c3fe3084da2caa7ff8'},
             'baln': {'zip': 'token_contracts/baln.zip', 'SCORE': 'cxc2ab1a0fc9c4eb72530f6dacb74bf5cfc93b3022'},
             'bwt': {'zip': 'token_contracts/bwt.zip', 'SCORE': 'cxebab2e03164b95dedb1c0a0bf18bc581986fcac3'}}
...
call = CallBuilder().from_(wallet.get_address()).to(contracts['rewards']['SCORE']).method('getRecipientsSplit').params(
    {}).build()
result = icon_service.call(call)
print(result)
...
transaction = TransactionBuilder().from_(wallet.get_address()).to(contracts['dex']['SCORE']).value(10 * ICX).step_limit(
    10000000).nid(NID).nonce(101).build()
signed_transaction = SignedTransaction(transaction, wallet)
tx_hash = icon_service.send_transaction(signed_transaction)
tx_hash
...
call = CallBuilder().from_(wallet.get_address()).to(contracts['dex']['SCORE']).method('getICXBalance').params(
    {'_address': wallet.get_address()}).build()
result = icon_service.call(call)
int(result, 0) / 10 ** 18
...
transaction = CallTransactionBuilder().from_(btest_wallet.get_address()).to(contracts['governance']['SCORE']).value(
    0).step_limit(10000000).nid(NID).nonce(100).method("dexAddQuoteCoin").params(
    {'_address': 'cx65f639254090820361da483df233f6d0e69af9b7'}).build()
...
transaction = CallTransactionBuilder().from_(btest_wallet.get_address()).to(contracts['governance']['SCORE']).value(
    0).step_limit(10000000).nid(NID).nonce(100).method("dexAddQuoteCoin").params(
    {'_address': 'cxaa068556df80f9917ef146e889f0b2c4b13ab634'}).build()
signed_transaction = SignedTransaction(transaction, btest_wallet)
tx_hash = icon_service.send_transaction(signed_transaction)
tx_hash
...
transaction = CallTransactionBuilder().from_(wallet.get_address()).to(contracts['staking']['SCORE']).value(
    100 * ICX).step_limit(10000000).nid(NID).nonce(100).method("stakeICX").params(params).build()
signed_transaction = SignedTransaction(transaction, wallet)
tx_hash = icon_service.send_transaction(signed_transaction)
tx_hash
...
call = CallBuilder().from_(wallet.get_address()).to(contracts['sicx']['SCORE']).method('balanceOf').params(
    {'_owner': user1.get_address()}).build()
result = icon_service.call(call)
int(result, 0) / 10 ** 18
...
transaction = CallTransactionBuilder().from_(user1.get_address()).to(contracts['sicx']['SCORE']).value(0).step_limit(
...
call = CallBuilder().from_(wallet.get_address()).to('cx65f639254090820361da483df233f6d0e69af9b7').method(
    'balanceOf').params({'_owner': wallet.get_address()}).build()
result = icon_service.call(call)
int(result, 0) / 10 ** 6
...
transaction = CallTransactionBuilder().from_(wallet.get_address()).to(
    'cx65f639254090820361da483df233f6d0e69af9b7').value(0).step_limit(10000000).nid(NID).nonce(100).method(
...
transaction = CallTransactionBuilder().from_(user2.get_address()).to(
    'cx9f03e46d637fb0b1c7b539873c7f25db2ddc94e6').value(0).step_limit(10000000).nid(NID).nonce(100).method(
    "transfer").params(params).build()
...
params = {'_to': contracts['dex']['SCORE'], '_value': 50 * ICX, '_data': data}
transaction = CallTransactionBuilder().from_(wallet.get_address()).to(
    'cxaa068556df80f9917ef146e889f0b2c4b13ab634').value(0).step_limit(10000000).nid(NID).nonce(100).method(
    "transfer").params(params).build()
signed_transaction = SignedTransaction(transaction, wallet)
tx_hash = icon_service.send_transaction(signed_transaction)
tx_hash
...
transaction = CallTransactionBuilder().from_(user2.get_address()).to(contracts['dex']['SCORE']).value(0).step_limit(
    10000000).nid(NID).nonce(100).method("add").params(
    {'_baseToken': 'cx9f03e46d637fb0b1c7b539873c7f25db2ddc94e6', '_quoteToken': contracts['sicx']['SCORE'],
     '_maxBaseValue': 15 * ICX, '_quoteValue': 1 * ICX}).build()
signed_transaction = SignedTransaction(transaction, user2)
tx_hash = icon_service.send_transaction(signed_transaction)
tx_hash
...
transaction = CallTransactionBuilder().from_(user2.get_address()).to(contracts['dex']['SCORE']).value(0).step_limit(
    10000000).nid(NID).nonce(100).method("add").params({'_baseToken': 'cx9f03e46d637fb0b1c7b539873c7f25db2ddc94e6',
                                                        '_quoteToken': 'cx65f639254090820361da483df233f6d0e69af9b7',
                                                        '_maxBaseValue': 15 * ICX, '_quoteValue': 1 * 10 ** 6}).build()
signed_transaction = SignedTransaction(transaction, user2)
tx_hash = icon_service.send_transaction(signed_transaction)
tx_hash
...
transaction = CallTransactionBuilder().from_(user2.get_address()).to(contracts['dex']['SCORE']).value(0).step_limit(
    10000000).nid(NID).nonce(100).method("add").params({'_baseToken': 'cx9f03e46d637fb0b1c7b539873c7f25db2ddc94e6',
                                                        '_quoteToken': 'cxaa068556df80f9917ef146e889f0b2c4b13ab634',
                                                        '_maxBaseValue': 15 * ICX, '_quoteValue': 1 * ICX}).build()
signed_transaction = SignedTransaction(transaction, user2)
tx_hash = icon_service.send_transaction(signed_transaction)
tx_hash
...
transaction = CallTransactionBuilder().from_(btest_wallet.get_address()).to(contracts['governance']['SCORE']).value(
    0).step_limit(10000000).nid(NID).nonce(100).method("setMarketName").params({'_pid': 2, '_name': 'OMMSICX'}).build()
signed_transaction = SignedTransaction(transaction, btest_wallet)
tx_hash = icon_service.send_transaction(signed_transaction)
tx_hash
...
transaction = CallTransactionBuilder().from_(btest_wallet.get_address()).to(contracts['governance']['SCORE']).value(
    0).step_limit(10000000).nid(NID).nonce(100).method("setMarketName").params({'_pid': 3, '_name': 'OMMIUSDC'}).build()
signed_transaction = SignedTransaction(transaction, btest_wallet)
tx_hash = icon_service.send_transaction(signed_transaction)
tx_hash
...
transaction = CallTransactionBuilder().from_(btest_wallet.get_address()).to(contracts['governance']['SCORE']).value(
    0).step_limit(10000000).nid(NID).nonce(100).method("setMarketName").params({'_pid': 4, '_name': 'OMMUSDB'}).build()
signed_transaction = SignedTransaction(transaction, btest_wallet)
tx_hash = icon_service.send_transaction(signed_transaction)
tx_hash
...
call = CallBuilder().from_(user1.get_address()).to(contracts['dex']['SCORE']).method('getDataBatch').params(
    {'_name': 'OMMSICX', '_limit': 10, '_snapshot_id': 1}).build()
result = icon_service.call(call)
print(result)

# Cell 46

call = CallBuilder().from_(wallet.get_address()).to(contracts['dex']['SCORE']).method('getPoolTotal').params(
    {'_pid': 4, '_token': 'cxaa068556df80f9917ef146e889f0b2c4b13ab634'}).build()
result = icon_service.call(call)
int(result, 0) / 10 ** 18

# Cell 48
# gives total supply of quote token of the pool
call = CallBuilder().from_(wallet.get_address()).to(contracts['dex']['SCORE']).method('totalSupply').params(
    {'_pid': 3}).build()
result = icon_service.call(call)
int(result, 0) / 10 ** 18
...
call = CallBuilder().from_(wallet.get_address()).to(contracts['dex']['SCORE']).method('getPoolId').params(
    {'_token1Address': 'cx9f03e46d637fb0b1c7b539873c7f25db2ddc94e6',
     '_token2Address': contracts['sicx']['SCORE']}).build()
result = icon_service.call(call)
