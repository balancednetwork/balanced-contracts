...
class BalancedTestBaseDividends(IconIntegrateTestBase):
    ...
    constants = {"dex": [
        ...
        "dividends": [{"U_SECONDS_DAY": ["U_SECONDS_DAY = 120000000", "U_SECONDS_DAY = 86400 * 10**6"]}],
        "baln": [{"DAY_TO_MICROSECOND": ["DAY_TO_MICROSECOND = 120000000", "DAY_TO_MICROSECOND = 86400 * 10 ** 6"]}]}
    ...
    def setUp(self):
        ...
        for key, value in self.constants.items():
            ...
            path = "../core_contracts/"
            if key == "baln":
                path = "../token_contracts/"
            for i in value:
                lis1 = []
                for x, y in i.items():
                    lis1.append(x)
                    # lis1.append(y)
                    self.patch_constants(path + key + "/utils/consts.py", lis1[0], y[0])
        ...
        for key, value in self.constants.items():
            ...
            for i in value:
                ...
                for x, y in i.items():
                    lis1.append(x)
                    # lis1.append(y)
                    self.patch_constants(path + key + "/utils/consts.py", lis1[0], y[1])
