...
from token_contracts.bnXLM.bnXLM import BalancedLumens, EXA
from token_contracts.bnXLM.utils.checks import SenderNotScoreOwnerError, SenderNotAuthorized, SenderNotGovernance
from token_contracts.bnXLM.tokens.IRC2 import ZeroValueError
...
class TestBNXLM(ScoreTestCase):
    def setUp(self):
        ...
        self.test_account4 = Address.from_string(f"hx{'1434' * 10}")
        self.owner_address = Address.from_string(f"hx{'1524' * 10}")
        self.governance_address = Address.from_string(f"hx{'8426' * 10}")
        account_info = {
        ...
        self.score = self.get_score_instance(BalancedLumens, self.owner_address,
    ...
    def test_last_price_in_loop(self):
        ...
        self.assertEqual(215478398522753896, return_data)
