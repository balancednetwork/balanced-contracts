...
class BalancedTestBaseAllocation(IconIntegrateTestBase):
    ...
    constants = {"dex": [
        ...
        "governance": [{"U_SECONDS_DAY": ["U_SECONDS_DAY = 180000000", "U_SECONDS_DAY = 86400 * (10 ** 6)"]},
                       {"DAY_ZERO": ["DAY_ZERO = 18647 * 480", "DAY_ZERO = 18647"]}],
    ...
    BLOCK_INTERVAL = 4
    PREPS = {
        "hx9eec61896a7010c867ce24c20e69588e2832bc52",
    ...
    def setUp(self):
        ...
        self.nid = 3
        self.send_icx(self._test1, self.btest_wallet.get_address(), 100_0000 * self.icx_factor)
        ...
        self.send_icx(self._test1, self.user3.get_address(), 1_000_000 * self.icx_factor)
        self.send_icx(self._test1, self.user2.get_address(), 1_000_000 * self.icx_factor)
        self.send_icx(self._test1, self.user4.get_address(), 1_000_000 * self.icx_factor)
        self.send_icx(self._test1, self.user5.get_address(), 1_000_000 * self.icx_factor)
        # self.send_icx(self._test1, self.user6.get_address(), 1_000_000 * self.icx_factor)
        # self.send_icx(self._test1, self.user7.get_address(), 1_000_000 * self.icx_factor)
        # self.send_icx(self._test1, self.user8.get_address(), 1_000_000 * self.icx_factor)
        # self.send_icx(self._test1, self.user9.get_address(), 1_000_000 * self.icx_factor)
        # self.send_icx(self._test1, self.user10.get_address(), 1_000_000 * self.icx_factor)
    ...
    def _wallet_setup(self):
        ...
        self.user3: 'KeyWallet' = self._wallet_array[9]
        self.user4: 'KeyWallet' = self._wallet_array[10]
        self.user5: 'KeyWallet' = self._wallet_array[11]
        # self.user6: 'KeyWallet' = self._wallet_array[18]
        # self.user7: 'KeyWallet' = self._wallet_array[13]
        # self.user8: 'KeyWallet' = self._wallet_array[14]
        # self.user9: 'KeyWallet' = self._wallet_array[15]
        # self.user10: 'KeyWallet' = self._wallet_array[16]
        # self.user11: 'KeyWallet' = self._wallet_array[17]
    ...
    def _deploy_all(self):
        ...
        for idx, tx_result in enumerate(results):
            bheight = self.icon_service.get_block(tx_result['blockHeight'])
            self.assertTrue('status' in tx_result)
