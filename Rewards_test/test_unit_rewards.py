...
from core_contracts.reserve_fund.reserve_fund import ReserveFund
...
class TestRewards(ScoreTestCase):
    def setUp(self):
        ...
        self.reward.setBalnAddress(self.bal.address)
        self.reward.setBwtAddress(self.bwt.address)
        self.reward.setReserveAddress(self.reserve.address)
