...
class StakedLp(IconScoreBase):
    ...
    def _stake(self, _user: Address, _id: int, _value: int) -> None:
        ...
        # Form RewardsData Object
        data = {
            "_user": _user,
            "_balance": previous_balance
        }
        _rewardsData = {
            "_name": name,
            "_totalSupply": previous_total,
            "_data": [data]
        }
        _singleRewardsData = {
            "_name": name,
        ...
        rewards.updateBatchRewardsData(_rewardsData)
        #rewards.updateRewardsData(_singleRewardsData)
