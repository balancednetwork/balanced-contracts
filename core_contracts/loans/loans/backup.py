...
#         if _symbol in self.asset_db.symbol_list:
...
#         if key in self.asset_db.active_address_list:
...
#             for symbol in self.asset_db.symbol_list:
...
#         if _id == -1:
#             return False
#         for symbol in self.asset_db.active_address_list:
...
#             return 0
#         value = 0
#         for symbol in self.asset_db.active_collateral_list:
...
#         for symbol in assets.symbol_list:
